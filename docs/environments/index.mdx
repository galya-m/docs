...
We are planning to augment the list of supportedn etworks. If you need to use Nevermined on any other network, please let us know [through Discord](https://discord.gg/GZju2qScKq).
...
This means multiple versions of Smart Contracts ( `v1.3.5` and `v2.0.5`) for the same network and environment, allowing you to integrate either depending on your development lifecycle.
