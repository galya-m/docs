...
Existing networks have different characteristics related to the underlying blockchain network and whether they are a production or a test environment.

## Blockchain networks supported

Nevermined Smart Contracts are EVM compatible so they can be deployed in any EVM compatible blockchain network. Currently we support deployments on:
...
For each blockchain network we support we have Production and Testing deployments. This can help you to go through a typical development/testing process and further release into production independently of the blockchain network you use.
...
This means for the same network and environment you could have multiple Smart Contracts versions `v1.3.5` and `v2.0.5`, allowing you to integrate one or the other depending on your development lifecycle.
