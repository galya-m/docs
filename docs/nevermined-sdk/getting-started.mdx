...
To connect to Nevermined you need to first download the artifacts containing the abis of the Nevermined contracts. You can do so from the artifacts repo.
