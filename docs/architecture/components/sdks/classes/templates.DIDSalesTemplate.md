[@nevermined-io/nevermined-sdk-js](../README.md) / [Exports](../modules.md) / [templates](../modules/templates.md) / DIDSalesTemplate
...
- [`BaseTemplate`](templates.BaseTemplate.md)<`Record`<`string`, `unknown`\>\>
...
[src/keeper/contracts/templates/DIDSalesTemplate.ts:33](https://github.com/nevermined-io/sdk-js/blob/56fc18a/src/keeper/contracts/templates/DIDSalesTemplate.ts#L33)
...
▸ **instanceFromDDO**(`agreementId`, `ddo`, `creator`, `parameters`): `Promise`<[`AgreementInstance`](../interfaces/templates.AgreementInstance.md)<`Record`<`string`, `unknown`\>\>\>
...
`Promise`<[`AgreementInstance`](../interfaces/templates.AgreementInstance.md)<`Record`<`string`, `unknown`\>\>\>
...
[src/keeper/contracts/templates/DIDSalesTemplate.ts:15](https://github.com/nevermined-io/sdk-js/blob/56fc18a/src/keeper/contracts/templates/DIDSalesTemplate.ts#L15)
...
[src/keeper/contracts/templates/DIDSalesTemplate.ts:11](https://github.com/nevermined-io/sdk-js/blob/56fc18a/src/keeper/contracts/templates/DIDSalesTemplate.ts#L11)
...
[src/keeper/contracts/templates/DIDSalesTemplate.ts:23](https://github.com/nevermined-io/sdk-js/blob/56fc18a/src/keeper/contracts/templates/DIDSalesTemplate.ts#L23)
...
[src/keeper/contracts/templates/DIDSalesTemplate.ts:27](https://github.com/nevermined-io/sdk-js/blob/56fc18a/src/keeper/contracts/templates/DIDSalesTemplate.ts#L27)
